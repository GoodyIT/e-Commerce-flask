$(function () {
    ...
    $( "#report_order_history_apply" ).click(function() {
    ...
    $( "#report_order_history_export_csv" ).click(function() {
        ...
        .done(function(res) {
            ...
            link.setAttribute("download", "report_order_history.csv");
    ...
    $( "#report_order_history_export_excel" ).click(function() {
        ...
        .done(function(res) {
            ...
            saveAs(new Blob([buf],{type:"application/octet-stream"}), 'report_order_history.xlsx');
        });
    });
    $( "#report_order_history_export_doc" ).click(function() {
        ...
        .done(function(res) {
            ...
            if(navigator.msSaveOrOpenBlob ){
                ...
                downloadLink.download = 'report_order_history.doc';
    ...
    $( "#report_order_history_export_pdf" ).click(function() {
        ...
        .done(function(res) {
            ...
            doc.save('report_order_history.pdf');
        });
    });
})